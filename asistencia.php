	...
	<body class="home" >
				...
				<ul id="nav" class="sf-menu">
					...
					<li><a href="#">Administración</a>
						<ul>
							...
							<li><a href="http://reservation.mayakoba.com/prestamo.php">Préstamo Equipo</a></li>
                            <li><a href="http://reservation.mayakoba.com/registro.php">Registro Asistencia</a></li>
                         </ul>
                     </li>
		...
		<div id="main">
			<div class="wrapper cf">
				...
				<p><h4><font color="#FFFFFF">ASISTENCIA</font></h4></p>
