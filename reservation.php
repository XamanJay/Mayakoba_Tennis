				...
				<form id="contactForm" action="insertareservacion.php" method="post">
					<fieldset>
                        	...
                        	<table width="100%" cellspacing="0" cellpadding="0" >
                               ...
                               <td width="20%">
                                     <label class="AMARILLO">HORARIOS DISPONIBLES EN CANCHA 3 Y CANCHA 4, ES SOLO DE 06:00 a 16:00</label>
                                  <td width="2%"></tr>
                           ...
                           <table width="100%" cellspacing="0" cellpadding="0">
             					...
             					<tr>
                                   ...
                                   <td width="35%">
                                            ...
                                            <label for="email" ><font color="#000"><h5>Email</h5>
                                ...
                                <tr>
                                   ...
                                   <td>
                                            ...
                                            <input name="jc_date"  id="jc_date" type="text" class="form-poshytip" title="Selecciona la fecha y hora" onClick="viewCalendar('jcalendar_parent', 'jc_date')"/>  
                            	...
                            	<tr>
                                	<td width="33%">
                                          ...
                                          <label for="comments" ><font color="#000"><h5>Comentario</h5></label>
                                           <textarea name="comments"  id="comments" rows="3" cols="10" style="width:142px; height:80px;" title="Comentarios"></textarea>                             		</td>
                           			<td width="33%">
                      ...
                      <div class="clearfix"></div>
                   			...
                   			<table  style="background:#000; color:#FFF; opacity:0.80;">
                                ...
                                <tr>	
                                	<td> &nbsp;&nbsp;&nbsp;Las requetas y las pelotas serán proporcionado por el hotel. </td>
                                </tr>
                                <tr>	
