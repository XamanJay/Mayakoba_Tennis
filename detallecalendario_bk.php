	...
	<!-- HEADER -->
		...
		<div id="main">
			<div class="wrapper cf">
                    ...
                    <?php
						$querySQL='';
						/*$querySQL="SELECT r.id_reservacion,r.cancha,r.hora_reservacion,r.guid,r.status,j.nombre_jugador,j.hotel,j.habitacion,c.nombre_contacto,c.telefono1,r.tipo_usuario
									FROM jugadores j
...
j.hotel,j.habitacion,c.nombre_contacto,c.telefono1,r.tipo_usuario 
FROM reservation.jugadores j inner join reservacion r on j.id_reservacion= r.id_reservacion
inner join contacto c on j.id_contacto = c.id_contacto
where r.fecha_reservacion='$fechar' and r.status='activo'";
