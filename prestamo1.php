...
tbody tr:hover {
	...
	<body class="home" >
               ...
               <form id="contactForm" action="prestamo_ok.php" method="post" >
					<fieldset> 

 <?php
                $querySQL='';
				$querySQL="Select j.apellido_jugador,j.nombre_jugador,r.hora_reservacion,r.guid,r.cancha from reservacion r inner join jugadores j on r.id_reservacion=j.id_reservacion where j.nombre_jugador='$nombre'"; 
...
?>  
                      ...
                      <input type="hidden" name="aux" value="<?php echo $aux; ?>">
						<p><input type="submit" value="Prestar" name="submit" id="submit" /> 
					</fieldset>
					</font>
				</form>
