...
<?php     
 ...
 <?php
				...
				$querySQL="SELECT r.fecha_reservacion,r.id_reservacion,r.cancha,r.hora_reservacion,r.guid,r.status,j.nombre_jugador,j.apellido_jugador,j.hotel,j.habitacion,c.nombre_contacto,c.apellido_contacto,c.telefono1,r.fecha_sistemas 
 ...
 while($reservacion=mysql_fetch_array($resultado)){
            ...
            ?>
             ...
             <tr>
                 ...
                 <td> <font color="#FFFFFF"> <?php echo $reservacion["fecha_sistemas"];?> </font> </td> </tr>
         <?php      
    }    
?>
