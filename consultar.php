	...
	<body class="home" >
		...
		<div id="main">
			<div class="wrapper cf">
				...
				<p><h1><font color="#FFFFFF">CONSULTAR RESERVACIONES</font></h1></p>
				
				<!-- form -->
			
				<form id="contactForm" action="..consultar.php?fecha_reservacion=<?php echo $fechar;?>" method="post" >
					<fieldset>
...
?>
						...
						<p><input type="submit" value="Consultar" name="submit" id="submit" /> 
					</fieldset>
					</font>
				</form>
