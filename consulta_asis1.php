...
tbody tr:hover {
 ...
 <?php
                $querySQL='';
				$querySQL="Select j.apellido_jugador,j.nombre_jugador,r.hora_reservacion,r.guid,r.cancha,a.asistencia from reservacion r inner join (jugadores j inner join asistencia a on j.id_jugador=a.id_jugador) on r.id_reservacion=a.id_reservacion where j.nombre_jugador='$nombre'"; 
 ...
 <thead>
					<tr>
                        ...
                        <th align="center"> <font color="#FFFFFF"> Asistencia</font></th>
            ...
            ?>
             ...
             <tr>
                ...
                <td> <font color="#FFFFFF"><?php echo $reservacion["nombre_jugador"]; ?> </font></td>
                 ...
                 <td> <font color="#FFFFFF"><?php  echo $reservacion["asistencia"]; ?>  </font></td>
		        </tr>
         <?php      
    }    
?>  
