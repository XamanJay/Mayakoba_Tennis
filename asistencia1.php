...
tbody tr:hover {
	...
	<body class="home" >
               ...
               <form id="contactForm" action="insertaasistencia.php" method="post" >
					<fieldset> 

 <?php
                $querySQL='';
				$querySQL="Select j.id_reservacion,j.apellido_jugador,r.hora_reservacion,r.cancha from reservacion r inner join jugadores j on r.id_reservacion=j.id_reservacion where j.nombre_jugador='$nombre'"; 
 ...
 <thead>
					<tr>
                    	<th align="center"> <font color="#FFFFFF"> Jugador	</font></th>
                        <th align="center"> <font color="#FFFFFF"> Hora Reservación	</font></th>
                        <th align="center"> <font color="#FFFFFF"> Cancha </font></th>
                        <th align="center"> <font color="#FFFFFF"> Asistio </font></th>
                        <th align="center"> <font color="#FFFFFF"> Falto </font></th>
						</tr>
					</tr>
				</thead>
 <?php   
 ...
 while($reservacion=mysql_fetch_array($resultado)){
            ...
            ?>
             ...
             <tr>
                 ...
                 <td> <font color="#FFFFFF"><?php  echo $reservacion[""].'<input type="checkbox" name="formDoor[]" value='.$reservacion['hora_reservacion'].'>'; ?>  </font></td>
                 <td> <font color="#FFFFFF"><?php  echo $reservacion[""].'<input type="checkbox" name="formDoor1[]" value='.$reservacion['hora_reservacion'].'>'; ?>  </font></td>
		         </tr>
         <?php      
    }    
?>
                      ...
                      <input type="hidden" name="nombre_jugador" value="<?php echo $nombre; ?>">
						<p><input type="submit" value="Asistencia" name="submit" id="submit" /> 
					</fieldset>
					</font>
				</form>
